            ...
            <div class="bg-white overflow-hidden shadow-xs sm:rounded-lg">
                <div class="py-12 px-6 mx-auto max-w-screen-xl lg:px-6">
                    <div class="mb-8 text-center">
                        <h1 class="mb-2 text-3xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-4xl">
                            {{ $title }}
                        </h1>
                        <p class="text-base text-gray-600 dark:text-gray-400">
                            Kumpulan tulisan, cerita, dan pemikiran dari Naia Blog.
                        </p>
                    </div>
                    ...
                    <div class="my-7 grid gap-8 lg:grid-cols-3 md:grid-cols-2">
                        @forelse ($posts as $post)
                            <article
                                ...
                                <div class="line-clamp-3 mb-5 font-light text-gray-500 dark:text-gray-400">
                                ...
                                <div class="flex justify-between items-center">
                                    <div class="flex items-center space-x-4">
                                        <img class="w-7 h-7 rounded-full"
                                            ...
                                            alt="{{ $post->author->name }}" /><span
                                            class="font-medium text-sm dark:text-white">
                        ...
                        @empty
                            <div>
                                ...
                                <a href="/posts" class="text-blue-600 hover:underline hover:text-blue-900">&laquo; Back
                                    to all
                                    posts.</a>
                            </div>
                        @endforelse
