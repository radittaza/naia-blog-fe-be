<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            ...
            @if (Auth::check())
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <span @class([
                        'border rounded bg-blue-100 py-1 px-4' => true,
                        'bg-blue-500 border-blue-500' => request()->routeIs('dashboard'),
                        'border-gray-300 hover:bg-blue-200' => !request()->routeIs('dashboard'),
                    ])>
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <div class="flex items-center px-5">
                                <div class="shrink-0">
                                    <img src="{{ Auth::check() && Auth::user()->avatar ? asset('storage/' . Auth::user()->avatar) : asset('img/avatar_default.jpg') }}"
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link href="/posts" :active="request()->is('posts')">Blog</x-responsive-nav-link>
