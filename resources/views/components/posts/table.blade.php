@if (Session::has('success'))
    <div class="flex justify-center">
        <div id="toast-success"
            class="absolute top-[8rem] transition-opacity flex items-center w-full max-w-sm p-4 text-body bg-neutral-primary-soft rounded-base shadow-xs border border-default"
            role="alert">
            <div class="inline-flex items-center justify-center shrink-0 w-7 h-7 text-fg-success bg-green-200 rounded">
    ...
    <script>
        setTimeout(() => {
            ...
            if (toast) {
                ...
                setTimeout(() => {
                    toast.remove();
                }, 500); // tunggu animasi fade selesai
            }
        }, 2000);
    </script>
@endif
...
@if (Session::has('delete'))
    <div class="flex justify-center">
        <div id="toast-danger"
            class="absolute top-[8rem] transition-opacity flex items-center w-full max-w-sm p-4 text-body bg-neutral-primary-soft rounded-base shadow-xs border border-default"
            role="alert">
            <div class="inline-flex items-center justify-center shrink-0 w-7 h-7 text-fg-danger bg-red-300 rounded">
                <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    fill="none" viewBox="0 0 24 24">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M6 18 17.94 6M18 18 6.06 6" />
            ...
            <div class="ms-3 text-sm font-normal">Post has been deleted.</div>
            <button type="button"
                class="ms-auto flex items-center justify-center text-body hover:text-heading bg-transparent box-border border border-transparent hover:bg-neutral-secondary-medium focus:ring-4 focus:ring-neutral-tertiary font-medium leading-5 rounded text-sm h-8 w-8 focus:outline-none"
                                ...
                                <td class="px-4 py-3 flex items-center justify-end">
                                    ...
                                    <div id="post-{{ $post->id }}-dropdown"
                                        ...
                                        <ul class="py-1 text-sm"
                                            ...
                                            <li>
                                                <a href="/dashboard/{{ $post->slug }}/edit" data-modal-target="updatePr1oductModal1"
                                                    data-modal-toggle="updateProduc1tModal1"
                                ...
                                <div class="relative p-4 w-full max-w-md max-h-full">
                                    ...
                                    <div
                                        ...
                                        <div class="flex justify-center items-center space-x-4">
                                            <button data-modal-toggle="deleteModal-{{ $post->id }}"
                                                type="button"
