                    ...
                    <div class="ml-4 flex items-center md:ml-6">
                        ...
                        <el-dropdown class="relative ml-3">
                            ...
                            class="relative flex max-w-xs items-center rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 cursor-pointer">
                                ...
                                <div class="text-white ml-3 font-medium">{{ Auth::user()->name }}</div>
                            </button>
                            ...
                            @else
                            <a href="/register" class="hover:text-gray-600 text-sm text-white font-medium">Register</a> <span class="text-white font-normal">|</span>
