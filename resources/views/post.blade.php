    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xs sm:rounded-lg">
                <div class="py-4 px-8 mx-auto max-w-screen-xl">

                    <article
                        class="mx-auto w-full max-w-screen format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">

                        <a href="/posts" class="text-xs font-semibold text-violet-500 hover:underline">
                        ...
                        @if (Auth::check() && Auth::id() === $post->author_id)
                            <div class="flex justify-between items-center mt-6">
                                ...
                                <button type="submit" data-modal-target="deleteModal-{{ $post->id }}"
